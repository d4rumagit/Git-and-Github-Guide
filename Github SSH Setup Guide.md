...
SSH (Secure Shell) keys are a pair of cryptographic keys that <mark>allow you to authenticate with GitHub without entering your username and password every time you push or pull.</mark> Think of it like a secure key card that lets you access your repositories automatically.
